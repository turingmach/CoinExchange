...
public class CoinExchangeServiceTest {
	...
	public void test_exchangeBills_success() throws Exception {
    	...
    	Map<Double, Integer> responseMap = coinExchangeService.exchange(request);
    	assertNotNull(responseMap);  
    	assertNotNull(responseMap.get(0.25));
    	assertEquals(Integer.valueOf(2), responseMap.get(0.25));
    	assertEquals(Integer.valueOf(5), responseMap.get(0.1));
    }
